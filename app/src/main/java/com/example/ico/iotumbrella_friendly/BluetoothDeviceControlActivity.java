 ...
 * Bluetooth LE API.
 */
public class BluetoothDeviceControlActivity extends Activity {
    private final static String TAG = BluetoothDeviceControlActivity.class.getSimpleName();
...
// http://nsamteladze.blogspot.kr/2012/10/show-dialog-in-android-after-device.html
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bluetooth_device_control);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case R.id.menu_connect:
                Log.v("BluetoothConnect","mDeviceAddress : " + mDeviceAddress);
                mBluetoothLeService.connect(mDeviceAddress);
                return true;
